...
export default function AIChatPanel() {
  ...
  if (!activeProvider) {
    return (
      <div className="h-full flex flex-col items-center justify-center bg-gray-950 p-8 text-center">
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-gray-800">
        <div className="flex gap-2">
          <Textarea
            ...
            className="flex-1 min-h-[60px] resize-none bg-gray-900 border-gray-700 text-gray-200"
            onKeyDown={(e) => {
